...
6. Wait for processing, then confirm the build appears in `PB Private Beta` in TestFlight. Use a build number higher than the last uploaded build, 206.
