...
Suggested confirmation text before import:

> Import only a model you own or have permission to use and display. SonaPin keeps the copied model on this device. Model metadata can describe permissions, but missing metadata does not grant rights.
